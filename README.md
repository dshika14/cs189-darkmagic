...
1. Look at the [slides](K_Means_Slides.pdf) and read the [notes](K_Means_DocumentationAndNotes.pdf) for an introduction to and overview of K-Means. The notes will give more details and clarifications on the theory behind K-Means, whereas the slides will give a general overview of the topic with visuals. 
